...
public class BlockEntityRegistry {
    ...
    public static final RegistryObject<BlockEntityType<FloweringLogAltarEntity>> FLOWERING_LOG_ALTAR =
            BLOCK_ENTITIES.register("flowering_log_altar", () ->
                    BlockEntityType.Builder.of(FloweringLogAltarEntity::new, BlockRegistry.FLOWERING_LOG_ALTAR.get()).build(null));
